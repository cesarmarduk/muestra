...
<div class="row row-sm">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('dashboard.settings.template.store') }}">
                    @include('dashboard.layouts.partials.errors')
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="name">Nombre</label>
                                <input autofocus class="form-control @if($errors->get('name')) is-invalid @endif" name="name" id="name" value="{{ old('name') }}" placeholder="Ingres nombre" type="text">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
