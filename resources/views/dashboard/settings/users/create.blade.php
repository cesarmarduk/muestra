...
<div class="row row-sm">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('dashboard.settings.user.store') }}">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group @if($errors->get('phone')) is-invalid @endif">
                                    ...
                                    <input type="text" id="phone" class="form-control form-control-lg text-white" name="phone" value="{{ old('phone') }}" placeholder="Ingrese teléfono">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="input-group @if($errors->get('address')) is-invalid @endif">
                                    ...
                                    <input type="text" id="address" class="form-control form-control-lg text-white" name="address" value="{{ old('address') }}" placeholder="Ingrese dirección">
                                </div>
                            </div>
                        </div>
                    </div>
