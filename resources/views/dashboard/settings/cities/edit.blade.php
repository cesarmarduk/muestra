...
<div class="row row-sm">
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('dashboard.settings.city.update', Crypt::encrypt($city->id)) }}">
                    @include('dashboard.layouts.partials.errors')
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="name">Nombre</label>
                                <input autofocus class="form-control @if($errors->get('name')) is-invalid @endif" name="name" id="name" value="{{ old('name', $city->name) }}" placeholder="Ingres ciudad" type="text">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="abbreviation">Abreviatura</label>
                                <input class="form-control @if($errors->get('abbreviation')) is-invalid @endif" name="abbreviation" id="abbreviation" value="{{ old('abbreviation', $city->abbreviation) }}" placeholder="Ingres abreviatura" type="text">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
