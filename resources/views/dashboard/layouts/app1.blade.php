...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>@yield('title', 'Home') | LGCverify</title>
        <!-- ================== END METAS ================== -->
        <!-- ================== CSRF Token ================== -->
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/singlemenu.css') }}">
        <!-- ================== END CSS ================== -->
        <!-- ================== BEGIN SCRIPTS ================== -->
        ...
        <script type="text/javascript" src="{{ asset('assets/js/single-menu.js') }}"></script>
        <script type="text/javascript" src="{{ asset('assets/js/sidebar.js') }}"></script>
        <script type="text/javascript" src="{{ asset('assets/js/sidebar-custom.js') }}"></script>
    ...
    <body class="main-body app sidebar-mini">
        ...
        <!-- Page closed -->
        <!-- Back-to-top -->
        <a href="#top" id="back-to-top"><i class="material-icons">arrow_upward</i></a>
        @yield('plugins')
        @yield('js')
    </body>
</html>
